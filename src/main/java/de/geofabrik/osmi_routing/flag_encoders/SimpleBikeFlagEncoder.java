...
/**
 * Simplified version of BikeCommonFlagEncoder needing less bits than the original but having the
 * same behaviour w.r.t. accepting or rejecting edges.
 * <p>
 *
 * @author Peter Karich
 * @author Nop
 ...
 */
public class SimpleBikeFlagEncoder extends AbstractFlagEncoder {
    ...
    public IntsRef handleWayTags(IntsRef edgeFlags, ReaderWay way, EncodingManager.Access access) {
        ...
        Integer priorityFromRelation = UNCHANGED.getValue();
